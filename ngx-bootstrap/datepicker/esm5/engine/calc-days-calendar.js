...
import { getStartingDayOfCalendar } from 'ngx-bootstrap/datepicker/esm5/utils/bs-calendar-utils';
import { createMatrix } from 'ngx-bootstrap/datepicker/esm5/utils/matrix-utils';
/**
 * @param {?} startingDate
 * @param {?} options
 * @return {?}
