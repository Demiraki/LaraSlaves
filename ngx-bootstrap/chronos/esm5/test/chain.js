...
import { add, subtract } from 'ngx-bootstrap/chronos/esm5';
import { getDate, getFullYear, getHours, getMilliseconds, getMinutes, getMonth, getSeconds } from 'ngx-bootstrap/chronos/esm5/utils/date-getters';
import { setDate, setFullYear, setHours, setMilliseconds, setMinutes, setMonth, setSeconds } from 'ngx-bootstrap/chronos/esm5/utils/date-setters';
import { cloneDate } from 'ngx-bootstrap/chronos/esm5/create/clone';
import { isArray, isBoolean, isDate, isDateValid, isFunction, isNumber, isObject, isString, isUndefined } from 'ngx-bootstrap/chronos/esm5/utils/type-checks';
import { formatDate } from 'ngx-bootstrap/chronos/esm5/format';
import { ISO_8601, RFC_2822 } from 'ngx-bootstrap/chronos/esm5/create/from-string-and-format';
import { getDateOffset, getUTCOffset, hasAlignedHourOffset, isDaylightSavingTime, setOffsetToParsedOffset, setUTCOffset } from 'ngx-bootstrap/chronos/esm5/units/offset';
import { isLeapYear, parseTwoDigitYear } from 'ngx-bootstrap/chronos/esm5/units/year';
import { isAfter, isBefore, isBetween, isSame, isSameOrAfter, isSameOrBefore } from 'ngx-bootstrap/chronos/esm5/utils/date-compare';
import { daysInMonth } from 'ngx-bootstrap/chronos/esm5/units/month';
import { getDayOfWeek, getISODayOfWeek, getLocaleDayOfWeek, parseWeekday, setDayOfWeek, setISODayOfWeek, setLocaleDayOfWeek } from 'ngx-bootstrap/chronos/esm5/units/day-of-week';
import { getISOWeek, getWeek, setISOWeek, setWeek } from 'ngx-bootstrap/chronos/esm5/units/week';
import { getISOWeeksInYear, getISOWeekYear, getSetISOWeekYear, getSetWeekYear, getWeeksInYear, getWeekYear } from 'ngx-bootstrap/chronos/esm5/units/week-year';
import { endOf, startOf } from 'ngx-bootstrap/chronos/esm5/utils/start-end-of';
import { getQuarter, setQuarter } from 'ngx-bootstrap/chronos/esm5/units/quarter';
import { getDayOfYear, setDayOfYear } from 'ngx-bootstrap/chronos/esm5/units/day-of-year';
import { getZoneAbbr, getZoneName } from 'ngx-bootstrap/chronos/esm5/units/timezone';
import { diff } from 'ngx-bootstrap/chronos/esm5/moment/diff';
import { calendar } from 'ngx-bootstrap/chronos/esm5/moment/calendar';
import { defineLocale, getLocale, getSetGlobalLocale, listLocales } from 'ngx-bootstrap/chronos/esm5/locale/locales';
import { max, min } from 'ngx-bootstrap/chronos/esm5/moment/min-max';
import { isDuration } from 'ngx-bootstrap/chronos/esm5/duration/constructor';
import { createLocalOrUTC } from 'ngx-bootstrap/chronos/esm5/create/from-anything';
import { createDuration } from 'ngx-bootstrap/chronos/esm5/duration/create';
/** @type {?} */
