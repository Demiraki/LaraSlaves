...
import { weekOfYear } from 'ngx-bootstrap/chronos/esm5/units/week-calendar-utils';
import { hasOwnProp, isArray, isFunction } from 'ngx-bootstrap/chronos/esm5/utils/type-checks';
import { getDay, getMonth, getFullYear } from 'ngx-bootstrap/chronos/esm5/utils/date-getters';
import { matchWord, regexEscape } from 'ngx-bootstrap/chronos/esm5/parse/regex';
import { setDayOfWeek } from 'ngx-bootstrap/chronos/esm5/units/day-of-week';
/**
 * @record
 */
