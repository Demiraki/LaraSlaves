...
// license : MIT
// momentjs.com
import 'ngx-bootstrap/chronos/esm5/units';
import { formatFunctions, makeFormatFunction } from 'ngx-bootstrap/chronos/esm5/format/format';
import { getLocale } from 'ngx-bootstrap/chronos/esm5/locale/locales';
import { isDateValid } from 'ngx-bootstrap/chronos/esm5/utils/type-checks';
/**
 * @param {?} date
 * @param {?} format
 * @param {?=} locale
