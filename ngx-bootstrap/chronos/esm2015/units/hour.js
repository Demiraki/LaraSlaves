 ...
 */
import { getHours, getMinutes, getSeconds } from 'ngx-bootstrap/chronos/esm2015/utils/date-getters';
import { addFormatToken } from 'ngx-bootstrap/chronos/esm2015/format/format';
import { zeroFill } from 'ngx-bootstrap/chronos/esm2015/utils/zero-fill';
import { addRegexToken, match1to2, match2, match3to4, match5to6 } from 'ngx-bootstrap/chronos/esm2015/parse/regex';
import { addParseToken } from 'ngx-bootstrap/chronos/esm2015/parse/token';
import { HOUR, MINUTE, SECOND } from 'ngx-bootstrap/chronos/esm2015/units/constants';
