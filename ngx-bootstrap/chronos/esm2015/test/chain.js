...
import { add, subtract } from 'ngx-bootstrap/chronos/esm2015';
import { getDate, getFullYear, getHours, getMilliseconds, getMinutes, getMonth, getSeconds } from 'ngx-bootstrap/chronos/esm2015/utils/date-getters';
import { setDate, setFullYear, setHours, setMilliseconds, setMinutes, setMonth, setSeconds } from 'ngx-bootstrap/chronos/esm2015/utils/date-setters';
import { cloneDate } from 'ngx-bootstrap/chronos/esm2015/create/clone';
import { isArray, isBoolean, isDate, isDateValid, isFunction, isNumber, isObject, isString, isUndefined } from 'ngx-bootstrap/chronos/esm2015/utils/type-checks';
import { formatDate } from 'ngx-bootstrap/chronos/esm2015/format';
import { ISO_8601, RFC_2822 } from 'ngx-bootstrap/chronos/esm2015/create/from-string-and-format';
import { getDateOffset, getUTCOffset, hasAlignedHourOffset, isDaylightSavingTime, setOffsetToParsedOffset, setUTCOffset } from 'ngx-bootstrap/chronos/esm2015/units/offset';
import { isLeapYear, parseTwoDigitYear } from 'ngx-bootstrap/chronos/esm2015/units/year';
import { isAfter, isBefore, isBetween, isSame, isSameOrAfter, isSameOrBefore } from 'ngx-bootstrap/chronos/esm2015/utils/date-compare';
import { daysInMonth } from 'ngx-bootstrap/chronos/esm2015/units/month';
import { getDayOfWeek, getISODayOfWeek, getLocaleDayOfWeek, parseWeekday, setDayOfWeek, setISODayOfWeek, setLocaleDayOfWeek } from 'ngx-bootstrap/chronos/esm2015/units/day-of-week';
import { getISOWeek, getWeek, setISOWeek, setWeek } from 'ngx-bootstrap/chronos/esm2015/units/week';
import { getISOWeeksInYear, getISOWeekYear, getSetISOWeekYear, getSetWeekYear, getWeeksInYear, getWeekYear } from 'ngx-bootstrap/chronos/esm2015/units/week-year';
import { endOf, startOf } from 'ngx-bootstrap/chronos/esm2015/utils/start-end-of';
import { getQuarter, setQuarter } from 'ngx-bootstrap/chronos/esm2015/units/quarter';
import { getDayOfYear, setDayOfYear } from 'ngx-bootstrap/chronos/esm2015/units/day-of-year';
import { getZoneAbbr, getZoneName } from 'ngx-bootstrap/chronos/esm2015/units/timezone';
import { diff } from 'ngx-bootstrap/chronos/esm2015/moment/diff';
import { calendar } from 'ngx-bootstrap/chronos/esm2015/moment/calendar';
import { defineLocale, getLocale, getSetGlobalLocale, listLocales } from 'ngx-bootstrap/chronos/esm2015/locale/locales';
import { max, min } from 'ngx-bootstrap/chronos/esm2015/moment/min-max';
import { isDuration } from 'ngx-bootstrap/chronos/esm2015/duration/constructor';
import { createLocalOrUTC } from 'ngx-bootstrap/chronos/esm2015/create/from-anything';
import { createDuration } from 'ngx-bootstrap/chronos/esm2015/duration/create';
/** @type {?} */
