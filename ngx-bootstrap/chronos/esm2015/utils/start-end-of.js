 ...
 */
import { setDate, setHours, setMilliseconds, setMinutes, setMonth, setSeconds } from 'ngx-bootstrap/chronos/esm2015/utils/date-setters';
import { cloneDate } from 'ngx-bootstrap/chronos/esm2015/create/clone';
import { setISODayOfWeek, setLocaleDayOfWeek } from 'ngx-bootstrap/chronos/esm2015/units/day-of-week';
import { getMonth } from 'ngx-bootstrap/chronos/esm2015/utils/date-getters';
import { add, subtract } from 'ngx-bootstrap/chronos/esm2015/moment/add-subtract';
/**
 * @param {?} date
 * @param {?} unit
 * @param {?=} isUTC
